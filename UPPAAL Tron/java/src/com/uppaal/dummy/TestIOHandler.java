...
public class TestIOHandler extends VirtualThread 
    implements Adapter, DummyListener
{
    /**
     ...
     */
    public TestIOHandler(DummyInterface dummy)
    {
	super("TestInput");
	this.dummy = dummy;
	start();
    ...
    {
	myInput1 = reporter.addInput("myInput1");
	myInput2 = reporter.addInput("myInput2");
	myOutput = reporter.addOutput("myOutput");
